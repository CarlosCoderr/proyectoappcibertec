...
object UsuarioRepository {
    ...
    fun obtenerSiguienteId(): Int {
        return if (UsuarioRepository.listaUsuarios.isEmpty()) 1 else UsuarioRepository.listaUsuarios.maxOf { it.codigo } + 1
    }

    fun buscarUsuario(correo: String, clave: String): Usuario? {
        return UsuarioRepository.listaUsuarios.find { it.correo == correo && it.clave == clave }
    }
}